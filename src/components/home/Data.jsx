...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h1 className="home__title">Hey! I'm... <br></br> Nikhil Gupta
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a web developer and AI enthusiast. Passionate about web development and AI, I'm seeking internships to further develop my skills and gain hands-on experience. 🚀🚀
        </p>
